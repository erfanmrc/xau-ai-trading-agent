export default function Home(){
 return <main style={{maxWidth:980,margin:'0 auto',padding:32}}>
  <h1>XAU AI Trading Agent — Batch 27</h1>
  ...
  <p>Exit rules: take-profit is the planned exit target derived from the strategy geometry; stop-loss remains active. Trend analysis controls trade direction and future entries, not forced early exits.</p>
