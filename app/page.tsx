export default function Home(){
 return <main style={{maxWidth:980,margin:'0 auto',padding:32}}>
  <h1>XAU AI Trading Agent — Patch 47</h1>
  ...
  <p>Risk rules: 0.5% initial risk, automatic X2 disabled by default, post-loss cooldown, and the existing daily risk budget.</p>
